...
<form:form modelAttribute="entidadDTO" name="entidadDTO" class="form-horizontal" enctype="multipart/form-data">	
  ...
  <div class="panel-footer">
    <!-- Button (Double) -->
 	<div class="form-group">
	  ...
	  <div class="col-md-6 col-xs-6">
	    <button type="submit" id="buttonGenerar" name="buttonGenerar" class="btn btn-success pull-right"><span class="glyphicon glyphicon-import"></span> Importar</button>
	  </div>
	</div>
  </div>
</div>
