...
<div class="form-group form-group-sm">
	<div class="list-group">
	  <a href="#" class="list-group-item">
	    <p class="list-group-item-text">Se usa para ver en que Comprobantes figura el Producto/Servicio. Si usa este filtro, se ignoraran los filtros Fecha Desde y Fecha Hasta</p>
	  </a>	  	   
	</div>				
</div>